 ...
 * </ul>
 */
public final class SSLTestCertificateGenerator {

    public static final String TEST_PASSPHRASE = "testpassphrase";
     ...
     */
    public static CertBundle generate(Path baseDir) throws Exception {
     ...
     */
    public static CertBundle withUnencryptedPkcs8PemKey(CertBundle base, Path outputPath) throws Exception {
     ...
     */
    public static CertBundle withUnencryptedPkcs1PemKey(CertBundle base, Path outputPath) throws Exception {
     ...
     */
    public static CertBundle withPkcs8EncryptedPemKey(CertBundle base, Path outputPath, String passphrase) throws Exception {
     ...
     */
    public static CertBundle withPkcs12Key(CertBundle base, Path outputPath, String passphrase) throws Exception {
     ...
     * <p>Output path must end with {@code .p12} for format detection by {@code PostgreSQLStateManager}.
     */
    public static CertBundle withPkcs12KeyNoPassword(CertBundle base, Path outputPath) throws Exception {
     ...
     */
    public static CertBundle withDerEncryptedKey(CertBundle base, Path outputPath, String passphrase) throws Exception {
     ...
     */
    public static CertBundle withDerUnencryptedKey(CertBundle base, Path outputPath) throws Exception {
     ...
     */
    public static CertBundle withClientCN(CertBundle base, String cn, Path outputDir) throws Exception {

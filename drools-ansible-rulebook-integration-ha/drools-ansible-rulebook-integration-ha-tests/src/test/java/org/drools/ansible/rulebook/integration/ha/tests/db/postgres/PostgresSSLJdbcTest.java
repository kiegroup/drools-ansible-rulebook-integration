...
public class PostgresSSLJdbcTest {
     ...
     */
    public static PostgreSQLContainer<?> createSSLPostgresContainer(SSLTestCertificateGenerator.CertBundle certs) throws Exception {

...
public class ExtractorTest {
    ...
    @Test
    void testSquaredRoot() throws Exception {
        final String expression = "[\"a\"].b[\"c\"].d[\"e/asd\"]['f'].g.h";
    ...
    @Test
    void testMixedBag() throws Exception {
    ...
    @Test
    void testMixedBagReverse() throws Exception {
        final String expression = "range[\"x\"][-1][2].a[\"b\"]";
    ...
    @Test
    void testMixedBagNullRange2() throws Exception {
    ...
    @Test
    void testMixedBagUndefFirstLevel() throws Exception {
    ...
    @Test
    void testMixedBagArrayIndexExistsButNullValue() throws Exception {
    ...
    @Test
    void testMixedBagArrayIndexUnexisting() throws Exception {
